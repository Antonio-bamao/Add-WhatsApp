...
contextBridge.exposeInMainWorld('addWhatsapp', {
  ...
  getPaymentOrderStatus: payload => ipcRenderer.invoke('cloud:order-status', payload),
  listPaymentOrders: () => ipcRenderer.invoke('cloud:list-payment-orders'),
  closePaymentOrder: payload => ipcRenderer.invoke('cloud:close-payment-order', payload),
