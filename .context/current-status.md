...
- 当前阶段：Phase 8.5，后台管理台、云端 API、PostgreSQL 持久化、管理员鉴权、桌面端云端登录/扣费和第二工作台云端租约闭环已跑通。
