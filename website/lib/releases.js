export const latestRelease = {
  ...
  sizeBytes: 228876916,
  sha256: "dff058a5d8b838fc7096e82e922cd8561d050014f3933128500610313e278c1e",
  highlights: [
    "新增强制更新弹窗，必须升级时会自动提示并重启安装",
    "后台收费模式生效时间默认留空，避免误排程到次日",
    "修复 Windows 桌面快捷方式显示 Electron 默认图标",
    "缩短自动更新启动检查延迟"
  ]
};
